...
{
    public class Lions : Animaux, IEnclo, IClassique
    {
        ...
        public Lions(string nom, double poids, double taille, Enum_Sexe sexe, DateTime datenaissance, ushort age, DateTime entreecage) : base(nom, poids, taille, sexe, datenaissance, age, entreecage)
        {
            _temperature = 24;
            _longueur = 4;
            _largeur = 3;
