...
{
    public class Tigres : Animaux, IEnclo, IClassique
    {
        ...
        public Tigres(string nom, double poids, double taille, Enum_Sexe sexe, DateTime datenaissance, ushort age, DateTime entreecage) : base(nom, poids, taille, sexe, datenaissance, age, entreecage)
        {
            _temperature = 18;
            _longueur = 3;
            _largeur = 3;
