...
{
    public class Hippopotames : Animaux, IEnclo, IClassique
    {
        ...
        public Hippopotames(string nom, double poids, double taille, Enum_Sexe sexe, DateTime datenaissance, ushort age, DateTime entreecage) : base(nom, poids, taille, sexe, datenaissance, age, entreecage)
        {
            _temperature = 16;
            _longueur = 7;
            _largeur = 6;
            ...
            _largeurBassin = 3;
            _longueurBassin = 3;
            _pronfondeurBassin = 4;
            _environnementType = Enum_Environnements.Foret;
            _hauteurGrillage = 3;
        }
    }
}
